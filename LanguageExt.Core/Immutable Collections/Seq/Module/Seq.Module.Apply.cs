...
public static partial class Seq
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<B> apply<A, B>(Seq<Func<A, B>> ff, Seq<A> fx) =>
        default(ApplSeq<A, B>).Apply(ff, fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<C> apply<A, B, C>(Seq<Func<A, B, C>> ff, Seq<A> fx, Seq<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<B> apply<A, B>(Func<A, B> ff, Seq<A> fx) =>
        default(ApplSeq<A, B>).Apply(Seq1(ff), fx);
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, C>> apply<A, B, C>(Seq<Func<A, B, C>> ff, Seq<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, C>> apply<A, B, C>(Func<A, B, C> ff, Seq<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, D>>> apply<A, B, C, D>(Seq<Func<A, B, C, D>> ff, Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, D>>> apply<A, B, C, D>(Func<A, B, C, D> ff, Seq<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, E>>>> apply<A, B, C, D, E>(Seq<Func<A, B, C, D, E>> ff, Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="E">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, E>>>> apply<A, B, C, D, E>(Func<A, B, C, D, E> ff, Seq<A> fx) =>
        curry(ff).Apply(fx);    
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, Func<E, F>>>>> apply<A, B, C, D, E, F>(
        Seq<Func<A, B, C, D, E, F>> ff, 
        Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> apply<A, B, C, D, E, F, G>(
        Seq<Func<A, B, C, D, E, F, G>> ff, 
        Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> apply<A, B, C, D, E, F, G, H>(
        Seq<Func<A, B, C, D, E, F, G, H>> ff, 
        Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> apply<A, B, C, D, E, F, G, H, I>(
        Seq<Func<A, B, C, D, E, F, G, H, I>> ff, 
        Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
