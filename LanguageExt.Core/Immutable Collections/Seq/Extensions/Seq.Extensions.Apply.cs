...
public static partial class SeqExtensions
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<B> Apply<A, B>(this Seq<Func<A, B>> ff, Seq<A> fx) =>
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<C> Apply<A, B, C>(this Seq<Func<A, B, C>> ff, Seq<A> fx, Seq<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<B> Apply<A, B>(this Func<A, B> ff, Seq<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, C>> Apply<A, B, C>(this Seq<Func<A, B, C>> ff, Seq<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, C>> Apply<A, B, C>(this Func<A, B, C> ff, Seq<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, D>>> Apply<A, B, C, D>(this Seq<Func<A, B, C, D>> ff, Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, D>>> Apply<A, B, C, D>(this Func<A, B, C, D> ff, Seq<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(this Seq<Func<A, B, C, D, E>> ff, Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="E">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Seq<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(this Func<A, B, C, D, E> ff, Seq<A> fx) =>
        curry(ff).Apply(fx);    
    ...
    public static Seq<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<A, B, C, D, E, F, G>(
        this Seq<Func<A, B, C, D, E, F, G>> ff, 
        Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static Seq<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<A, B, C, D, E, F, G, H>(
        this Seq<Func<A, B, C, D, E, F, G, H>> ff, 
        Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static Seq<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<A, B, C, D, E, F, G, H, I>(
        this Seq<Func<A, B, C, D, E, F, G, H, I>> ff, 
        Seq<A> fx) =>
        ff.Map(curry).Apply(fx);
