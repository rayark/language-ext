...
public static partial class LstExtensions
{
    ...
    public static IEnumerable<B> Action<A, B>(this IEnumerable<A> fa, IEnumerable<B> fb) =>
        default(ApplEnumerable<A, B>).Action(fa, fb);
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<B> Apply<A, B>(this IEnumerable<Func<A, B>> ff, IEnumerable<A> fx) =>
        default(ApplEnumerable<A, B>).Apply(ff, fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<C> Apply<A, B, C>(this IEnumerable<Func<A, B, C>> ff, IEnumerable<A> fx, IEnumerable<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<B> Apply<A, B>(this Func<A, B> ff, IEnumerable<A> fx) =>
        default(ApplEnumerable<A, B>).Apply(List(ff), fx);
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, C>> Apply<A, B, C>(this IEnumerable<Func<A, B, C>> ff, IEnumerable<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, C>> Apply<A, B, C>(this Func<A, B, C> ff, IEnumerable<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, D>>> Apply<A, B, C, D>(this IEnumerable<Func<A, B, C, D>> ff, IEnumerable<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, D>>> Apply<A, B, C, D>(this Func<A, B, C, D> ff, IEnumerable<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(this IEnumerable<Func<A, B, C, D, E>> ff, IEnumerable<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="E">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(this Func<A, B, C, D, E> ff, IEnumerable<A> fx) =>
        curry(ff).Apply(fx);    
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, Func<D, Func<E, F>>>>> Apply<A, B, C, D, E, F>(
        this IEnumerable<Func<A, B, C, D, E, F>> ff, 
        IEnumerable<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<A, B, C, D, E, F, G>(
        this IEnumerable<Func<A, B, C, D, E, F, G>> ff, 
        IEnumerable<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<A, B, C, D, E, F, G, H>(
        this IEnumerable<Func<A, B, C, D, E, F, G, H>> ff, 
        IEnumerable<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static IEnumerable<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<A, B, C, D, E, F, G, H, I>(
        this IEnumerable<Func<A, B, C, D, E, F, G, H, I>> ff, 
        IEnumerable<A> fx) =>
        ff.Map(curry).Apply(fx);
