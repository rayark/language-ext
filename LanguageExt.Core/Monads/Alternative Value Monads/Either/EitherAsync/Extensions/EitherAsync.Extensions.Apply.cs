...
/// <summary>
/// Extension methods for `EitherAsync`
/// </summary>
public static partial class EitherAsyncExtensions
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, B> Apply<L, A, B>(this EitherAsync<L, Func<A, B>> ff, EitherAsync<L, A> fx) =>
        default(ApplEitherAsync<L, A, B>).Apply(ff, fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, C> Apply<L, A, B, C>(this EitherAsync<L, Func<A, B, C>> ff, EitherAsync<L, A> fx, EitherAsync<L, B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, B> Apply<L, A, B>(this Func<A, B> ff, EitherAsync<L, A> fx) =>
        default(ApplEitherAsync<L, A, B>).Apply(ff, fx);
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, C>> Apply<L, A, B, C>(this EitherAsync<L, Func<A, B, C>> ff, EitherAsync<L, A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, C>> Apply<L, A, B, C>(this Func<A, B, C> ff, EitherAsync<L, A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, Func<C, D>>> Apply<L, A, B, C, D>(this EitherAsync<L, Func<A, B, C, D>> ff, EitherAsync<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, Func<C, D>>> Apply<L, A, B, C, D>(this Func<A, B, C, D> ff, EitherAsync<L, A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, Func<C, Func<D, E>>>> Apply<L, A, B, C, D, E>(
        this EitherAsync<L, Func<A, B, C, D, E>> ff, 
        EitherAsync<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, Func<C, Func<D, Func<E, F>>>>> Apply<L, A, B, C, D, E, F>(
        this EitherAsync<L, Func<A, B, C, D, E, F>> ff, 
        EitherAsync<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<L, A, B, C, D, E, F, G>(
        this EitherAsync<L, Func<A, B, C, D, E, F, G>> ff, 
        EitherAsync<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<L, A, B, C, D, E, F, G, H>(
        this EitherAsync<L, Func<A, B, C, D, E, F, G, H>> ff, 
        EitherAsync<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherAsync<L, Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<L, A, B, C, D, E, F, G, H, I>(
        this EitherAsync<L, Func<A, B, C, D, E, F, G, H, I>> ff, 
        EitherAsync<L, A> fx) =>
        ff.Map(curry).Apply(fx);
