...
public static partial class EitherUnsafeExtensions
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherUnsafe<L, B> Apply<L, A, B>(this EitherUnsafe<L, Func<A, B>> ff, EitherUnsafe<L, A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherUnsafe<L, Func<B, C>> Apply<L, A, B, C>(this EitherUnsafe<L, Func<A, B, C>> ff, EitherUnsafe<L, A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherUnsafe<L, Func<B, C>> Apply<L, A, B, C>(this Func<A, B, C> ff, EitherUnsafe<L, A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherUnsafe<L, Func<B, Func<C, D>>> Apply<L, A, B, C, D>(this EitherUnsafe<L, Func<A, B, C, D>> ff, EitherUnsafe<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static EitherUnsafe<L, Func<B, Func<C, D>>> Apply<L, A, B, C, D>(this Func<A, B, C, D> ff, EitherUnsafe<L, A> fx) =>
        curry(ff).Apply(fx);
    ...
    public static EitherUnsafe<L, Func<B, Func<C, Func<D, E>>>> Apply<L, A, B, C, D, E>(
        this EitherUnsafe<L, Func<A, B, C, D, E>> ff, 
        EitherUnsafe<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static EitherUnsafe<L, Func<B, Func<C, Func<D, Func<E, F>>>>> Apply<L, A, B, C, D, E, F>(
        this EitherUnsafe<L, Func<A, B, C, D, E, F>> ff, 
        EitherUnsafe<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static EitherUnsafe<L, Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<L, A, B, C, D, E, F, G>(
        this EitherUnsafe<L, Func<A, B, C, D, E, F, G>> ff, 
        EitherUnsafe<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static EitherUnsafe<L, Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<L, A, B, C, D, E, F, G, H>(
        this EitherUnsafe<L, Func<A, B, C, D, E, F, G, H>> ff, 
        EitherUnsafe<L, A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static EitherUnsafe<L, Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<L, A, B, C, D, E, F, G, H, I>(
        this EitherUnsafe<L, Func<A, B, C, D, E, F, G, H, I>> ff, 
        EitherUnsafe<L, A> fx) =>
        ff.Map(curry).Apply(fx);
