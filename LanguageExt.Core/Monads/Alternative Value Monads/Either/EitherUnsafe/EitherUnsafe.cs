...
namespace LanguageExt
{
    ...
    public readonly struct EitherUnsafe<L, R> :
        ...
        ISerializable
    {
        public static readonly EitherUnsafe<L, R> Bottom = new EitherUnsafe<L, R>();
        ...
        public override bool Equals(object? obj) =>
            obj is EitherUnsafe<L, R> e && Equals(e);
        ...
        public EitherUnsafe<L, Ret> Map<Ret>(Func<R?, Ret?> mapper) =>
            this switch
            {
                {IsRight: true} x => mapper(x.RightValue),
                {IsLeft: true} x => EitherUnsafe<L, Ret>.Left(x.LeftValue),
                _ => EitherUnsafe<L, Ret>.Bottom
            };
        ...
        public EitherUnsafe<Ret, R> MapLeft<Ret>(Func<L?, Ret?> mapper) =>
            this switch
            {
                {IsRight: true} x => EitherUnsafe<Ret, R>.Right(x.RightValue),
                {IsLeft: true} x => mapper(x.LeftValue),
                _ => EitherUnsafe<Ret, R>.Bottom
            };
        ...
        public EitherUnsafe<L2, R2> BiMap<L2, R2>(Func<R?, R2?> Right, Func<L?, L2?> Left) =>
            this switch
            {
                {IsRight: true} x => EitherUnsafe<L2, R2>.Right(Right(x.RightValue)),
                {IsLeft: true} x => EitherUnsafe<L2, R2>.Left(Left(x.LeftValue)),
                _ => EitherUnsafe<L2, R2>.Bottom
            };
