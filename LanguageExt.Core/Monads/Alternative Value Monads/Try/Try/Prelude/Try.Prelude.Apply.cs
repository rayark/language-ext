...
public static partial class Prelude
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Try<B> apply<A, B>(Try<Func<A, B>> ff, Try<A> fx) =>
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Try<C> apply<A, B, C>(Try<Func<A, B, C>> ff, Try<A> fx, Try<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Try<B> apply<A, B>(Func<A, B> ff, Try<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Try<Func<B, C>> apply<A, B, C>(Try<Func<A, B, C>> ff, Try<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Try<Func<B, C>> apply<A, B, C>(Func<A, B, C> ff, Try<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Try<Func<B, Func<C, D>>> apply<A, B, C, D>(Try<Func<A, B, C, D>> ff, Try<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static Try<Func<B, Func<C, D>>> apply<A, B, C, D>(Func<A, B, C, D> ff, Try<A> fx) =>
        curry(ff).Apply(fx);
