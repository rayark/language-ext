...
public static partial class Prelude
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOption<B> apply<A, B>(TryOption<Func<A, B>> ff, TryOption<A> fx) =>
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOption<C> apply<A, B, C>(TryOption<Func<A, B, C>> ff, TryOption<A> fx, TryOption<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOption<B> apply<A, B>(Func<A, B> ff, TryOption<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOption<Func<B, C>> apply<A, B, C>(TryOption<Func<A, B, C>> ff, TryOption<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOption<Func<B, C>> apply<A, B, C>(Func<A, B, C> ff, TryOption<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOption<Func<B, Func<C, D>>> apply<A, B, C, D>(TryOption<Func<A, B, C, D>> ff, TryOption<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOption<Func<B, Func<C, D>>> apply<A, B, C, D>(Func<A, B, C, D> ff, TryOption<A> fx) =>
        curry(ff).Apply(fx);
    ...
    public static TryOption<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> apply<A, B, C, D, E, F, G>(
        TryOption<Func<A, B, C, D, E, F, G>> ff, 
        TryOption<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static TryOption<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> apply<A, B, C, D, E, F, G, H>(
        TryOption<Func<A, B, C, D, E, F, G, H>> ff, 
        TryOption<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static TryOption<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> apply<A, B, C, D, E, F, G, H, I>(
        TryOption<Func<A, B, C, D, E, F, G, H, I>> ff, 
        TryOption<A> fx) =>
        ff.Map(curry).Apply(fx);
