...
public static partial class Prelude
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryAsync<B> apply<A, B>(TryAsync<Func<A, B>> ff, TryAsync<A> fx) =>
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryAsync<C> apply<A, B, C>(TryAsync<Func<A, B, C>> ff, TryAsync<A> fx, TryAsync<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryAsync<B> apply<A, B>(Func<A, B> ff, TryAsync<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryAsync<Func<B, C>> apply<A, B, C>(TryAsync<Func<A, B, C>> ff, TryAsync<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryAsync<Func<B, C>> apply<A, B, C>(Func<A, B, C> ff, TryAsync<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryAsync<Func<B, Func<C, D>>> apply<A, B, C, D>(TryAsync<Func<A, B, C, D>> ff, TryAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryAsync<Func<B, Func<C, D>>> apply<A, B, C, D>(Func<A, B, C, D> ff, TryAsync<A> fx) =>
        curry(ff).Apply(fx);
    ...
    public static TryAsync<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> apply<A, B, C, D, E, F, G>(
        TryAsync<Func<A, B, C, D, E, F, G>> ff, 
        TryAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static TryAsync<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> apply<A, B, C, D, E, F, G, H>(
        TryAsync<Func<A, B, C, D, E, F, G, H>> ff, 
        TryAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static TryAsync<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> apply<A, B, C, D, E, F, G, H, I>(
        TryAsync<Func<A, B, C, D, E, F, G, H, I>> ff, 
        TryAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
