...
/// </summary>
public static partial class TryOptionAsyncExtensions
{
    /// <summary>
    /// Applicative action
    /// </summary>
    ...
    public static TryOptionAsync<B> Action<A, B>(this TryOptionAsync<A> fa, TryOptionAsync<B> fb) =>
        default(ApplTryOptionAsync<A, B>).Action(fa, fb);
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<B> Apply<A, B>(this TryOptionAsync<Func<A, B>> ff, TryOptionAsync<A> fx) =>
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<C> Apply<A, B, C>(this TryOptionAsync<Func<A, B, C>> ff, TryOptionAsync<A> fx, TryOptionAsync<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<B> Apply<A, B>(this Func<A, B> ff, TryOptionAsync<A> fx) =>
        default(ApplTryOptionAsync<A, B>).Apply(TryOptionAsyncSucc(ff), fx);
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, C>> Apply<A, B, C>(this TryOptionAsync<Func<A, B, C>> ff, TryOptionAsync<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, C>> Apply<A, B, C>(this Func<A, B, C> ff, TryOptionAsync<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, Func<C, D>>> Apply<A, B, C, D>(this TryOptionAsync<Func<A, B, C, D>> ff, TryOptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, Func<C, D>>> Apply<A, B, C, D>(this Func<A, B, C, D> ff, TryOptionAsync<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(
        this TryOptionAsync<Func<A, B, C, D, E>> ff, 
        TryOptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, Func<C, Func<D, Func<E, F>>>>> Apply<A, B, C, D, E, F>(
        this TryOptionAsync<Func<A, B, C, D, E, F>> ff, 
        TryOptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<A, B, C, D, E, F, G>(
        this TryOptionAsync<Func<A, B, C, D, E, F, G>> ff, 
        TryOptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<A, B, C, D, E, F, G, H>(
        this TryOptionAsync<Func<A, B, C, D, E, F, G, H>> ff, 
        TryOptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static TryOptionAsync<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<A, B, C, D, E, F, G, H, I>(
        this TryOptionAsync<Func<A, B, C, D, E, F, G, H, I>> ff, 
        TryOptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
