...
public static partial class Prelude
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<B> apply<A, B>(OptionUnsafe<Func<A, B>> ff, OptionUnsafe<A> fx) =>
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<C> apply<A, B, C>(OptionUnsafe<Func<A, B, C>> ff, OptionUnsafe<A> fx, OptionUnsafe<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<B> apply<A, B>(Func<A, B> ff, OptionUnsafe<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, C>> apply<A, B, C>(OptionUnsafe<Func<A, B, C>> ff, OptionUnsafe<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, C>> apply<A, B, C>(Func<A, B, C> ff, OptionUnsafe<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, D>>> apply<A, B, C, D>(OptionUnsafe<Func<A, B, C, D>> ff, OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, D>>> apply<A, B, C, D>(Func<A, B, C, D> ff, OptionUnsafe<A> fx) =>
        curry(ff).Apply(fx);
    ...
    public static OptionUnsafe<Func<B, Func<C, Func<D, E>>>> apply<A, B, C, D, E>(
        OptionUnsafe<Func<A, B, C, D, E>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, F>>>>> apply<A, B, C, D, E, F>(
        OptionUnsafe<Func<A, B, C, D, E, F>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> apply<A, B, C, D, E, F, G>(
        OptionUnsafe<Func<A, B, C, D, E, F, G>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> apply<A, B, C, D, E, F, G, H>(
        OptionUnsafe<Func<A, B, C, D, E, F, G, H>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> apply<A, B, C, D, E, F, G, H, I>(
        OptionUnsafe<Func<A, B, C, D, E, F, G, H, I>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
