...
/// </summary>
public static partial class OptionUnsafeExtensions
{
    /// <summary>
    /// Applicative action
    /// </summary>
    ...
    public static OptionUnsafe<B> Action<A, B>(this OptionUnsafe<A> fa, OptionUnsafe<B> fb) =>
        default(ApplOptionUnsafe<A, B>).Action(fa, fb);
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<B> Apply<A, B>(this OptionUnsafe<Func<A, B>> ff, OptionUnsafe<A> fx) =>
        default(ApplOptionUnsafe<A, B>).Apply(ff, fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionAsync<C> Apply<A, B, C>(this OptionAsync<Func<A, B, C>> ff, OptionAsync<A> fx, OptionAsync<B> fy) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<B> Apply<A, B>(this Func<A, B> ff, OptionUnsafe<A> fx) =>
        default(ApplOptionUnsafe<A, B>).Apply(SomeUnsafe(ff), fx);
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, C>> Apply<A, B, C>(this OptionUnsafe<Func<A, B, C>> ff, OptionUnsafe<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, C>> Apply<A, B, C>(this Func<A, B, C> ff, OptionUnsafe<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, D>>> Apply<A, B, C, D>(this OptionUnsafe<Func<A, B, C, D>> ff, OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, D>>> Apply<A, B, C, D>(this Func<A, B, C, D> ff, OptionUnsafe<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(
        this OptionUnsafe<Func<A, B, C, D, E>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, F>>>>> Apply<A, B, C, D, E, F>(
        this OptionUnsafe<Func<A, B, C, D, E, F>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<A, B, C, D, E, F, G>(
        this OptionUnsafe<Func<A, B, C, D, E, F, G>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<A, B, C, D, E, F, G, H>(
        this OptionUnsafe<Func<A, B, C, D, E, F, G, H>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionUnsafe<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<A, B, C, D, E, F, G, H, I>(
        this OptionUnsafe<Func<A, B, C, D, E, F, G, H, I>> ff, 
        OptionUnsafe<A> fx) =>
        ff.Map(curry).Apply(fx);
