...
public static partial class OptionAsyncExtensions
{
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionAsync<B> Apply<A, B>(this OptionAsync<Func<A, B>> ff, OptionAsync<A> fx) =>
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionAsync<B> Apply<A, B>(this Func<A, B> ff, OptionAsync<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionAsync<Func<B, C>> Apply<A, B, C>(this OptionAsync<Func<A, B, C>> ff, OptionAsync<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionAsync<Func<B, C>> Apply<A, B, C>(this Func<A, B, C> ff, OptionAsync<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionAsync<Func<B, Func<C, D>>> Apply<A, B, C, D>(this OptionAsync<Func<A, B, C, D>> ff, OptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static OptionAsync<Func<B, Func<C, D>>> Apply<A, B, C, D>(this Func<A, B, C, D> ff, OptionAsync<A> fx) =>
        curry(ff).Apply(fx);
    ...
    public static OptionAsync<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(
        this OptionAsync<Func<A, B, C, D, E>> ff, 
        OptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionAsync<Func<B, Func<C, Func<D, Func<E, F>>>>> Apply<A, B, C, D, E, F>(
        this OptionAsync<Func<A, B, C, D, E, F>> ff, 
        OptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionAsync<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<A, B, C, D, E, F, G>(
        this OptionAsync<Func<A, B, C, D, E, F, G>> ff, 
        OptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionAsync<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<A, B, C, D, E, F, G, H>(
        this OptionAsync<Func<A, B, C, D, E, F, G, H>> ff, 
        OptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    public static OptionAsync<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<A, B, C, D, E, F, G, H, I>(
        this OptionAsync<Func<A, B, C, D, E, F, G, H, I>> ff, 
        OptionAsync<A> fx) =>
        ff.Map(curry).Apply(fx);
